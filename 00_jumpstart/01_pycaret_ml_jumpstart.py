...
# GOAL: Make an introductory ML lead scoring model that can be used in an API
...
subscribers_joined_df = subscribers_df.copy()
...
# * Predict -----
new_df = pd.DataFrame(
    dict(member_rating=[4], country_code=["us"])
)
