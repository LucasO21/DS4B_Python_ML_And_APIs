...
# ========================================================================
logs_df = mlflow.search_runs(experiment_ids=experiment_1.experiment_id)
...
# Note - In production, we will only want to use models that have been finalized (source tag)
...
best_run_details = mlflow.get_run("98eb5b2fdc374e938c709c52dff87a35")
...
import mlflow
logged_model = 'runs:/98eb5b2fdc374e938c709c52dff87a35/model'
