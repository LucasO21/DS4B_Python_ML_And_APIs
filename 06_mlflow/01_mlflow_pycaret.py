...
best_run_id = logs_df \
    ...
    .sort_values('metrics.AUC', ascending=False)['run_id'][0]
...
best_run_details = mlflow.get_run("83a295ee41844a0a81bc832102eef2a1")
...
import mlflow
logged_model = 'runs:/83a295ee41844a0a81bc832102eef2a1/model'
