...
The plot below shows and example of some of the new features created and their relationship with our target *made_purchase*. The plot shows the likelihood of making a purchase based on 9 randomly selected tags (events). Looking at one example (Learning Lab 09) we can see that if a subsriber attened that event, they have a 19% likelihood of making a purchase vs only 5% if they did not attend the event.  We can also see similar trends for the other tags, indicating that having these additional features could be very indicative of *made_purchase*.
