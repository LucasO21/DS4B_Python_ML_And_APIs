...
As mentioned earlier, this analysis provides a lead scoring solution for a company for an online educational company. The company offers training cources (their main product) in data science and has a large email list of **100,000** subscribers (or leads), with a monthly growth rate of **6,000** new subscribers. The marketing team also sends out **5** emails per month and the business's scales cycle generates approximately **$250,000** in revenue per month.

::: {.callout-note}
**Subscribers** and **Leads** will be used interchangebly throughout this project. Note they both refer to the same thing.
:::
...
To understand how these values are calculated, please see [this]().
:::
...
| Expected Value (with New Leadscoring Strategy) | Value    | Description                                           |
|------------------------------------------------|:---------|:----------------------------------------------------- |
| Revenue in First Month                         | $237,266 | Sales in first month of implementing new strategy     |
| New Revenue (Post Nurturing Cold Leads)        | $290,148 | Expected total sales after nurturing cold leads       |
| Expected Monthly Savings                       | $52,882  | Expected Monthly savings of implementing new strategy |
| Expected Saved Customers                       | 33       | Expected saved customers after nurturing cold leads   |
...
::: {.callout-note title="BSPF Phase"}
This section is part of the last 3 phases of the BSPF **(Encode Algorithms, Measure Results and Report Financial Impact)**. Deploying ML models and enabling users to engage with these strategies is key to these last 3 phases of the BSPF.
:::
